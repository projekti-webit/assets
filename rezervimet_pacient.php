<?php 
    ...
    function doktoret () {
     ...
     function gjenero_rezervime_temeparshme() {
     	...
     	//$query = " SELECT  'r.dataora', 'r.email_pacienti', 'p.emri', 'p.mbiemri' FROM rezervim r join perdoruesit p on 'r.id_doktori' = 'p.user_id' where id_pacienti = '".$_SESSION["user_id"]."' ";
