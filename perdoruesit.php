<?php 
    ...
    function kerkimi()
    {
        ...
        while ($row = mysqli_fetch_array($pergjigje_kerkim))
         {
            echo "Po kerkoni per:  " .$row["emri"]. " " . $row['mbiemri']. " ?";
            echo "<br>";
            //$em = !empty($kerkohet)?highlight_keywords($row['emri'], $kerkohet):$row['emri'];
            //$mb = !empty($kerkohet)?highlight_keywords($row['mbiemri'], $kerkohet):$row['mbiemri'];
    ...
    //function highlight_keywords($kerkimi,$kerkohet){
           // $wordsArray = explode(" ", $kerkohet);
          //  $wordsCount = count($wordsArray);
          //  for($i=0;$i<$wordsCount;$i++)
          // {
         //    $highlighted_text = "<span style='font-weight:bold;background-color: #F9F902;'>$wordsArray[$i]</span>";
          //   $text = str_ireplace($wordsArray[$i], $highlighted_text, $kerkohet);
          // }
