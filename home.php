			...
			<div class="col-md-9 col-sm-9">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                       ...
                       ?>
                         <button name="upload_foto" id="upload_foto" class="btn btn-primary" data-toggle="modal"  data-target="#foto_upload">Ngarko foto profili</button><br>
                         <!--/. <img src="echo 'uploads/'.$image; " alt="foto profili">   -->
                         <?php
                         if(isset ($_SESSION['user_id'])) {
                          $id = $_SESSION['user_id'];
                          echo "<img src ='uploads/profile".$id.".jpg' class='img-thumbnail' class='rounded float-left' >";
                         }else{
                          echo " <img src ='uploads/profiledefault.jpg' class='img-thumbnail' class='rounded float-left'>";
                         }
                          ?>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                    	<ul class="nav nav-pills">
                            <li class=""><a href="#shenime" data-toggle="tab">Shenime</a>
                            </li>
                            <li class=""><a href="#ndrysho_passwd" data-toggle="tab">Siguria</a>
                            </li>
                            <li class=""><a href="#send_mail" data-toggle="tab">Email</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="shenime">
                               <form action="home.php" method="post">
                               
                                <textarea rows="10" cols="30" name = "area" id = "area" placeholder="rikujtese.."></textarea>

                                
                                <button type="button" class="btn btn-primary" onclick="download()">Ruaj</button>
                                 </form>
                                 <!--/.  <?php //shtoshenim() ?>
                                <?php 
                                //function shtoshenim(){$shenimi = $_POST['area'];
                               // if(isset($_POST['shto'])&& !empty($shenimi))
                                 // echo '<textarea rows="10" cols="30"  name = "area" id = "area" placeholder="rikujtese.."></textarea>';}
        ...
        <div class="modal-content">
          <form action="upload.php" method="post" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                ...
                <input type="submit" value="Upload Image" name="Posto" class="btn btn-primary">
